// import { signup } from '@/app/utils/server/signup/actions';
...
//                     Nome
//                     <input name="name" type="text" autoComplete="name" className="grow" placeholder="Digite o primeiro nome" />
//                 </label>
//                 { state?.errors?.name && <p className='text-error'>{state.errors.name}</p> }

//                 <label className="input input-primary input-bordered flex items-center gap-2 mt-5 bg-white text-black mx-5">
//                     Sobrenome
//                     <input name="surname" type="text" autoComplete="surname" className="grow" placeholder='Digite o sobrenome'/>
//                 </label>
//                 { state?.errors?.name && <p className='text-error'>{state.errors.name}</p> }
...
//                     </label>
//                     { state?.errors?.password && <p className='text-error'>{state.errors.password}</p> }
//                 </div>
//                 <div className='flex flex-col mt-3 mb-5 mx-5'>
...
//                         <option disabled value={'D'}>Desenvolvedor</option>
//                     </select>
//                     { state?.errors?.profile && <p className='text-error'>{state.errors.profile}</p> }
//                 </div>
//                 <Submit/>
